...
\affiliation{%
  ...
  \department{Department of Computer Engineering -- Master in Internet of Things}
  \city{Fisciano (SA)}
  \country{Italy}
}
\email{b.hakmirzaev@studenti.unisa.it}

\renewcommand{\shortauthors}{B. Hakmirzaev (NF22500050)}
...
\begin{teaserfigure}
\centering
\textbf{Course:} Software Dependability \hspace{1cm} \textbf{Professor:} Dario Di Nucci \hspace{1cm} \textbf{Matricola:} NF22500050
\end{teaserfigure}
...
This project was completed as part of the Software Dependability course in the Master's program in Internet of Things at the University of Salerno. Special thanks to Professor Dario Di Nucci for his guidance on software dependability practices and quality assurance methodologies.
