...
public class VetRepositoryBenchmark {
	...
	/**
	 * Benchmark: Find all vets (tests caching performance).
	 */
	@Benchmark
	public void findAllVets(Blackhole bh) {
		bh.consume(vetRepository.findAll());
	}

	/**
	 * Benchmark: Find all vets with cache hit (second call should be cached).
	 */
	@Benchmark
	public void findAllVetsCached(Blackhole bh) {
